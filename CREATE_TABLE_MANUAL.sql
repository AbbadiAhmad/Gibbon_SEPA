-- Manual SQL Migration for SEPA Update Request Table
-- Run this directly in your MySQL database if you can't wait for Gibbon module update

-- Create the gibbonSEPAUpdateRequest table
CREATE TABLE IF NOT EXISTS `gibbonSEPAUpdateRequest` (
